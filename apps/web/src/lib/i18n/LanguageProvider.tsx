...
const translations: Record<LanguageCode, Record<string, string>> = {
  pt: {
    ...
    "settings.security.subtitle": "Gerencie sessoes ativas e recuperacao de senha com foco em seguranca.",
    "settings.security.sessionTitle": "Sessoes ativas",
    "settings.security.loading": "Carregando sessoes...",
    "settings.security.refreshAction": "Atualizar sessoes",
    "settings.security.revokeAction": "Revogar sessao",
    "settings.security.revokeSuccess": "Sessao revogada com sucesso.",
    "settings.security.currentBadge": "Sessao atual",
    "settings.security.otherBadge": "Outro dispositivo",
    "settings.security.activeBadge": "Ativa",
    "settings.security.revokedBadge": "Revogada",
    "settings.security.recoveryTitle": "Recuperacao de senha",
    "settings.security.recoveryRequestedInfo":
      "Solicitacao enviada. Em ambientes finais, enviaremos instrucoes por canal externo."
  },
  es: {
    ...
    "settings.security.subtitle": "Gestiona sesiones activas y recuperacion de contrasena con foco en seguridad.",
    "settings.security.sessionTitle": "Sesiones activas",
    "settings.security.loading": "Cargando sesiones...",
    "settings.security.refreshAction": "Actualizar sesiones",
    "settings.security.revokeAction": "Revocar sesion",
    "settings.security.revokeSuccess": "Sesion revocada correctamente.",
    "settings.security.currentBadge": "Sesion actual",
    "settings.security.otherBadge": "Otro dispositivo",
    "settings.security.activeBadge": "Activa",
    "settings.security.revokedBadge": "Revocada",
    "settings.security.recoveryTitle": "Recuperacion de contrasena",
    "settings.security.recoveryRequestedInfo":
      "Solicitud enviada. En ambientes finales enviaremos instrucciones por canal externo."
  },
  en: {
    ...
    "settings.security.subtitle": "Manage active sessions and password recovery with a security-first flow.",
    "settings.security.sessionTitle": "Active sessions",
    "settings.security.loading": "Loading sessions...",
    "settings.security.refreshAction": "Refresh sessions",
    "settings.security.revokeAction": "Revoke session",
    "settings.security.revokeSuccess": "Session revoked successfully.",
    "settings.security.currentBadge": "Current session",
    "settings.security.otherBadge": "Other device",
    "settings.security.activeBadge": "Active",
    "settings.security.revokedBadge": "Revoked",
    "settings.security.recoveryTitle": "Password recovery",
    "settings.security.recoveryRequestedInfo":
      "Request received. In staging/production, instructions will be delivered out-of-band."
  }
};
